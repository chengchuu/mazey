...
| `getFriendlyInterval`     | Calculate an interval as days, seconds, or Chinese text   | Universal          | Defaults to whole days; `type: "text"` returns `天/时/分/秒`; negative intervals return an empty string. |
